...
<main class="form-signin w-100 m-auto">
  <form method="post" action="../index.php">
    ...
    <p style="color: white;font-size:200%;">Données bien ajoutées à la base de donnée</p>

    
    <button class="w-100 btn btn-lg btn-primary" type="submit">Retour a l'accueil</button>
